    ...
    <div class="row">
      ...
      <div class="flexModalHotspotContainer">
       <div class="">
        ...
        <?php echo Form::button('supprimer les hotspots', ['class'=>'btnCart Btn added', 'type'=>'submit']); ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <div class="flexModalHotspotContainer">
            ...
            <?php echo Form::button('GO !', ['class'=>'cartBtn Btn add', 'type'=>'submit']); ?>
...
<!--             <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button> -->
            ...
            <input type="text" name="combien" value="unique" hidden>
            <?php echo Form::button('supprimer le hotspot', ['class'=>'btnCart Btn added', 'type'=>'submit']); ?>
  ...
  $(document).ready(function(e) {
    ...
    $('.hotspotTarget').append('<div id="'+'<?php echo e($hotspots[$spot]->id); ?>'+'" data-link="'+<?php echo e($hotspots[$spot]->image_link); ?>+'" class="circleSmall" style="background-color:dodgerblue;position:absolute;width:20px;top:'+posy+';left:'+posx+';" onclick="myFunction(this.id)" data-toggle="modal" data-target="#myModal"></div>');
