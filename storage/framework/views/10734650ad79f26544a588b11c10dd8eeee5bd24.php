        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="aboutContent">
                    <div class="aboutCell">
                        <h2>Votre expérience :<br><?php echo e($exp->name); ?></h2>
                        <div class="aboutTxt">
                            <p>Info : <?php echo e($exp->about); ?>  <br>Adresse : <?php echo e($exp->adress); ?>
                            ...
                            <br>Prix : <?php echo e($exp->price); ?>  <br>Ville :                            <?php if($exp->ville == '01'): ?>
                                                       ...
                                                       <?php elseif($exp->ville == '9D'): ?>
                                                            9D - R&eacute;union
                                                       <?php endif; ?><br>
                            Propriétaire : <?php echo e($exp->owner); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="sectionTitle">
                    <div class="h2">détails complémentaires</div>
                </div>
            </div>
        </div>
        <div class="row">
