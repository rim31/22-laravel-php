                            ...
                            <?php if($user->id_user == Auth::user()->id): ?>
                                ...
                                <tr>
                                  <?php if($user->id_exp == $exp->id): ?>
                                    ...
                                    <td>
                                        <?php if($exp->photo): ?>
                                            <a href="<?php echo e(route('exp.photo.index',[$exp->id])); ?>"><img src="/img/<?php echo e($exp->id); ?>/<?php echo e($exp->photo); ?>" alt="<?php echo e($exp->photo); ?>" style="width:200px;height:100px;" /></a>
                                        <?php else: ?>
