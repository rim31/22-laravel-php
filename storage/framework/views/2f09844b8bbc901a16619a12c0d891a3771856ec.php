                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <span class="inputTitle">
                                        ...
                                        <?php echo Form::text('name', null, ['class' =>'text', 'maxlength' => '20']); ?>
                                ...
                                <div class="col-sm-6">
                                    <span class="inputTitle">
                                        ...
                                        <?php echo Form::text('name_owner', null, ['class' =>'text']); ?>

                                    </span>
                                </div>
                                <div class="col-sm-12">
                                    <span class="inputTitle">
                                        <?php echo Form::label('about', 'Information', ['class' => 'inputTitle']); ?>

                                        <!-- <?php echo Form::textarea('about', null, ['class' =>'form-control', 'maxlength' => '50', 'rows'=> '2' ]); ?> -->
                                        <?php echo Form::text('about', null, ['class' =>'text', 'maxlength' => '50']); ?>
                                ...
                                <div class="col-sm-12">
                                    <span class="inputTitle">
                                        ...
                                        <!--  <?php echo Form::textarea('adress', null, ['class' =>'form-control','maxlength' => '50', 'rows'=> '2' ]); ?> -->
                                        <?php echo Form::text('adress', null, ['class' =>'text', 'maxlength' => '50']); ?>
                                ...
                                <div class="col-sm-6">
                                    <span class="inputTitle">
                                        ...
                                        <?php echo Form::text('price', null, ['class' =>'text']); ?>
