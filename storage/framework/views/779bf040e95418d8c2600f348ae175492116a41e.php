        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <?php echo Form::model($exp, array('route' => ['exp.update', $exp->id], 'method'=>'PUT',  'class' => ' col-md-12 contactForm')); ?>
                    ...
                    <div class="col-sm-12">
                        Propriétaire
                        <?php echo Form::text('name_owner', null, ['class' =>'form-control contactInput', 'maxlength' => '50']); ?>
