            ...
            <div class="availableDomain clearfix  animated">
                <div class="aDomainLeft clearfix">
                    <div class="DomainName">
                        <div class="h3">Editer votre experience</div>
                    </div>
                </div>
                <div class="domainBtn clearfix">
                    <?php echo e(link_to_route('exp.photo.index', 'Gallerie', [$exp->id], ['class' => 'btnCart Btn'])); ?>

                    <?php echo e(link_to_route('exp.index', 'Retour', [$exp->id], ['class' => 'ctaBtn Btn added'])); ?>
            ...
            <div class="col-md-12 animated">
                <div class="checkoutWrep">
                    <div class="row">
                        <div class="col-md-12">
                            <br>
                            <div class="bill">Modifier les informations</div>
                        </div>

                        <?php echo Form::open(array('route' => 'exp.store','method'=>'POST', 'files'=>true)); ?>

                        <div class="form-group col-sm-12">
                            <?php echo Form::label('name', 'Titre', ['class' => 'inputTitle']); ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select class="inputTitle" name="ville"  onChange="affiche_ville(this.value)"><option value="" label="ville"> </option>
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!-- // pour le futur à voir si on veut mettre une vieo ou phot de coverture
                    <div class="col-sm-4">
                        <div class="form-group">
