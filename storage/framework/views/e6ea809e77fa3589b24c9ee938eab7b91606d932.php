    ...
    <li class="availableDomain clearfix  animated">
      <div class="aDomainLeft clearfix">
        <div class="DomainName">
          <div class="h3">
            ...
            <!--<?php echo e(link_to_route('exp.photo.hotspot.index', $exp->name, [$exp->id, $exp->photo])); ?>--> 
          </div>
        </div>
      </div>
      <div class="domainBtn clearfix">         
        ...
        <span>
          ...
          <?php echo Form::button('Retour gallerie', ['class'=>'ctaBtn Btn', 'type'=>'submit']); ?>
        ...
        <div class="row selectLink ">
          ...
          <form action="<?php echo e(route('exp.photo.hotspot.store', [$exp->id, $id])); ?>" method="post">
            <div class="btn-group col-md-12 animated" data-toggle="buttons" >
              ...
              <?php if($joinexpimages[$i]->image_id != $id AND $joinexpimages[$i]->delete != 1): ?>
              <label class="btn btn-primary col-md-3">
                ...
                <div>
                  ...
                  <a href="#" class="pop miniature">
                    <img  id="link_id" value=<?php echo e($joinexpimages[$i]->image_id); ?>
