        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-sm-12">
                        Informations
                        <!-- <?php echo Form::label('about', 'informations', ['class' => 'inputTitle']); ?> -->
                        <?php echo Form::textarea('about', null, ['class' =>'form-control contactInput','maxlength' => '50', 'rows'=> '3' ]); ?>

                    </div>
                    <div class="form-group col-sm-12">
                        Prix
                        <!-- <?php echo Form::label('price', 'prix', ['class' => 'contactInput']); ?> -->
                        <?php echo Form::text('price', null, ['class' =>'form-control contactInput']); ?>

                    </div>
                    <div class="col-sm-12">
                        <!-- <div class="form-group"> -->
                            <!-- <?php echo Form::label('adress', 'adresse', ['class' => 'contactInput']); ?> -->
                        Adresse
                        <?php echo Form::textarea('adress', null, ['class' =>'form-control contactInput','maxlength' => '250', 'rows'=> '3' ]); ?>

                    </div>
                    <div class="col-sm-12">
                        Propriétaire
                        <!-- <?php echo Form::label('name_owner', 'propriétaire', ['class' => 'contactInput']); ?> -->
            ...
            <div class="contactArea secPdng animated">
        		<div class="container">
        			<div class="row">
                        ...
                        <div class="form-group col-sm-12">
                            <?php echo Form::label('name', 'Titre', ['class' => 'contactForm']); ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <?php echo Form::label('price', 'prix', ['class' => 'inputTitle']); ?>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <?php echo Form::label('adress', 'adresse', ['class' => 'inputTitle']); ?>
                            ...
                            Selectionner une ville
                            <div class="form-group">
                                <?php echo Form::label('name_owner', 'propriétaire', ['class' => 'inputTitle']); ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <?php echo Form::text('name', null, ['class' =>'form-control','maxlength' => '20']); ?>
