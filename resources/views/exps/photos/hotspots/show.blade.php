...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        {!! Form::button('GO !', ['class'=>'btn btn-info', 'type'=>'submit']) !!}
        {!! Form::close() !!}
  ...
  $(document).ready(function(e) {
   ...
   $('.hotspotTarget').append('<div id="'+'{{$hotspots[$spot]->id}}'+'" data-link="'+{{$hotspots[$spot]->image_link}}+'" class="circleSmall" style="background-color:red;position:absolute;width:20px;top:'+posy+';left:'+posx+';" onclick="myFunction(this.id)" data-toggle="modal" data-target="#myModal"></div>');
