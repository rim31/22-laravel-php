                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <span class="inputTitle">
                                        {!! Form::label('name', 'Titre', ['class' => 'inputTitle']) !!}
                                        <!--{!! Form::text('name', null, ['class' =>'form-control','maxlength' => '20']) !!}-->
                                        {!! Form::text('name', null, ['class' =>'text', 'maxlength' => '20']) !!}
                                    </span>
                                </div>
                                <div class="col-sm-6">
                                    <span class="inputTitle">
                                        {!! Form::label('name_owner', 'Propriétaire') !!}
                                        {!! Form::text('name_owner', null, ['class' =>'text']) !!}
                                    </span>
                                </div>
                                <div class="col-sm-12">
                                    <span class="inputTitle">
                                        {!! Form::label('about', 'Information', ['class' => 'inputTitle']) !!}
                                        <!-- {!! Form::textarea('about', null, ['class' =>'form-control', 'maxlength' => '50', 'rows'=> '2' ]) !!} -->
                                        {!! Form::text('about', null, ['class' =>'text', 'maxlength' => '50']) !!}
                                    </span>
                                </div>
                                <div class="col-sm-12">
                                    <span class="inputTitle">
                                        {!! Form::label('adress', 'Adresse', ['class' => 'inputTitle']) !!}
                                        <!--  {!! Form::textarea('adress', null, ['class' =>'form-control','maxlength' => '50', 'rows'=> '2' ]) !!} -->
                                        {!! Form::text('adress', null, ['class' =>'text', 'maxlength' => '50']) !!}
                                    </span>
                                </div>
                                <div class="col-sm-6">
                                    <span class="inputTitle">
                                ...
                                <div class="col-sm-6">
                                    <span class="inputTitle">
                                        ...
                                        {!! Form::text('price', null, ['class' =>'text']) !!}
                                    </span>
                                </div>
