        ...
        <div class="row">
            <div class="col-md-12">
                <div class="availableDomain clearfix  animated">
                    <div class="aDomainLeft clearfix">
                        <div class="DomainName">
                            <div class="h3">Modifier votre expérience</div>
                        </div>
                    </div>
                    <div class="domainBtn clearfix">
                        <!-- {{ link_to_route('exp.index', 'Retour', null, ['class' => 'btnBuy Btn']) }} -->
                    {{ link_to_route('exp.photo.index', 'Gallerie', [$exp->id], ['class' => 'btnCart Btn']) }}
                    {{ link_to_route('exp.index', 'Retour', [$exp->id], ['class' => 'ctaBtn Btn added']) }}
                ...
                <div class="col-md-12">
                    ...
                    {!! Form::model($exp, array('route' => ['exp.update', $exp->id], 'method'=>'PUT',  'class' => ' col-md-12 contactForm')) !!}
                    ...
                    <div class="form-group col-sm-12">
                        Prix
                        {!! Form::text('price', null, ['class' =>'form-control contactInput', 'maxlength' => '50']) !!}
                    </div>
                    <div class="col-sm-12">
                        Adresse
                        {!! Form::text('adress', null, ['class' =>'form-control contactInput','maxlength' => '50' ]) !!}
                    </div>
                    <div class="col-sm-12">
                        Propriétaire
                        {!! Form::text('name_owner', null, ['class' =>'form-control contactInput', 'maxlength' => '50']) !!}
                    </div>
                    <div class="col-sm-12">
