...
<head>
  ...
  <body class="hosting">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-9">
                        <a href="index-1.html" class="logo"><img src="{{ URL::asset('img/logo.png') }}" alt="immoVR"></a>
                    </div>
                ...
                <div class="col-sm-3">
                    <div class="footerInfo">
                        <a href="index-1.html" class="footerLogo">
                            <img src="{{ URL::asset('img/footerLogo.png') }}" alt="immoVR">
                        </a>
                        <div class="footerTxt">
    ...
    <script src="{{ URL::asset('js/jquery.1.11.3.min.js') }}"></script> <!-- jQuery -->
    <script src="{{ URL::asset('js/bootstrapJS/bootstrap.min.js') }}"></script> <!-- Bootstrap -->
    <script src="{{ URL::asset('js/owl.carousel.min.js') }}"></script> <!-- owlCarousel -->
    <script src="{{ URL::asset('js/waypoints.min.js') }}"></script> <!-- waypoint -->
    <script src="{{ URL::asset('js/chatScript.js') }}" type="text/javascript"></script> <!--End of Tawk.to Script-->
    <script src="{{ URL::asset('js/active.js') }}"></script> <!-- active js -->
    <!-- <script src="{{ URL::asset('js/hotspot.js') }}"></script> -->
    <!-- hotspot js -->
