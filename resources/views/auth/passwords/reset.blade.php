    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="checkoutWrep">
                <div class="bill panel-heading">{{ trans('login.reset') }}</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/password/reset') }}">
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            <label for="password-confirm" class="col-md-4 control-label">{{ trans('login.pass2') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="contactBtn Btn">
                                    <i class="fa fa-btn fa-refresh"></i>{{ trans('login.reset') }}
                                </button>
                            </div>
                        </div>
                    </form>
