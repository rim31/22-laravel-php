...
<html lang="en">
    ...
    <div class="dashboardArea secPdngB">
    	<div class="container">
    		<div class="row">
    			<div class="col-md-12 animated">
    				<div class="boardMenu">
    					<ul>
    						...
    						<li class="active"><a href="hostManage.html">Hosting Management</a></li>
    					</ul>
    				</div>
    			</div>
    			<div class="col-md-12  animated">
    				<div class="boardTitle">
    					<div class="h4">Your registered hosting accounts:</div>
    				</div>
    				<ul class="regDomains">
    					<li>
    						<div class="domainName"><a href="#">site_username</a></div>
    						<ul class="editDomain">
    					...
    					<li>
    						<div class="domainName"><a href="#">d360studio</a></div>
    						<ul class="editDomain">
    							<li><a href="#">cPanel</a></li>
    							<li><a href="#">Configure</a></li>
    							<li><a href="#">Edit</a></li>
    					...
    					<li>
    						<div class="domainName"><a href="#">spark_admin</a></div>
    						<ul class="editDomain">
    							<li><a href="#">cPanel</a></li>
    							<li><a href="#">Configure</a></li>
    							<li><a href="#">Edit</a></li>
